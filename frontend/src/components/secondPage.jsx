    ...
    <div className="flex flex-col md:flex-row justify-evenly items-center gap-5 p-4 mt-5 ">
      ...
      <div className="flex flex-col text-center">
        ...
        <div className="flex-col flex  md:flex-row justify-evenly items-center gap-5 mt-5">
          <div className="text-center rounded-lg text-gray-700 p-3 border border-gray-300  md:h-[100px]">
          ...
          <div className="text-gray-700 text-center text-sm p-3 border border-gray-300 rounded-lg md:h-[100px]">
            <h1 className="text-md font-bold ">Secure Communication</h1>
            <p className="text-sm italic flex flex-col">
              Protect your privacy and ensure secure communication with our
              encryption service.
              <code className="text-red-500 ">coming soon</code>
            </p>
          </div>
        </div>
      </div>
