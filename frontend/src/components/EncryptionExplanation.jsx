  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-evenly p-5 gap-5 lg:w-[90%] m-auto">
      ...
      <div className="flex flex-col justify-center items-center  border border-gray-100 p-3">
        <FaLock className="text-4xl mb-4 text-[#0BD0D9]" />
        <h3 className="text-xl font-semibold mb-2 text-[#3b878b]">
          Caesar Cipher
        </h3>
      ...
      <div className="flex flex-col justify-center items-center border border-gray-100 p-3">
        <FaCog className="text-4xl mb-4 text-[#10CF9B]" />
        <h3 className="text-xl font-semibold mb-2 text-[#46a189]">
          Custom Cipher
        </h3>
        <p className="text-gray-700">
